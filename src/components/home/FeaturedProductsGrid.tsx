...
export const FeaturedProductsGrid = () => {
  ...
  if (loading) {
    return <section className="py-6 md:py-12 px-0 md:px-4">
  ...
  return <section className="py-6 md:py-12 px-0 md:px-4">
      <div className="w-full md:container md:mx-auto">
        ...
        <div className="text-center mt-8">
          <Link to="/products" className="inline-flex items-center justify-center px-6 py-3 text-base font-medium border border-primary text-primary rounded-md hover:bg-primary hover:text-primary-foreground transition-colors">View All Designs</Link>
        </div>
      </div>
    </section>;
};