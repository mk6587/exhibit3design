...
const CheckoutPage = () => {
  ...
  const { user, profile, updateProfile, loading: authLoading, signInWithGoogle } = useAuth();
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-4">
            {/* Google Sign-in Section for guests */}
            {isGuest && (
              <div className="p-4 bg-muted/30 rounded-lg border mb-6">
                <div className="text-center space-y-4">
                  <p className="text-sm font-medium">Sign in to auto-fill your information and skip verification</p>
                  <Button 
                    variant="outline" 
                    onClick={async () => {
