...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    // Create clean HTML email content without problematic formatting
...
<p style="margin: 0; color: #0066cc; font-size: 14px;"><strong>Reply directly to this email to respond to ${name}</strong></p>
</div>
</div>
