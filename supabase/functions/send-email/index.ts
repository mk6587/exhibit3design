...
const getEmailTemplate = async (templateName: string, props: any): Promise<string> => {
  ...
  switch (templateName) {
    ...
    case 'otp-verification':
      const { OTPVerificationEmail } = await import('./_templates/otp-verification.tsx');
      return await renderAsync(React.createElement(OTPVerificationEmail, props));
...
// Legacy function - now using React Email template
